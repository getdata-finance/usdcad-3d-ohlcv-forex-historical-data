...
- **Free evaluation sample** on GitHub (`3d`) · **11 timeframes** on [getdata.finance](https://getdata.finance/datasets/usdcad) · **3,013** `3d` rows in the full archive
- Built for **backtesting**, **algorithmic trading** and **quantitative finance** workflows
- **Weekly refresh** — [getdata.finance](https://getdata.finance) every **Saturday, 8am UTC+0**; GitHub `3d` sample updated in sync

> **Sample on GitHub** · `USDCAD_3d.csv` (244 rows, `2024-09-02` -> `2026-09-01`, 27.71 KB). **Full archive on [getdata.finance](https://getdata.finance/datasets/usdcad)** — **3,013** `3d` rows (full `1m`: 9,133,625), **11 timeframes**, `2001-11-26` -> `2026-09-01`.
...
| 3d rows | 244 | **3,013** |
| Size | 27.71 KB | full ZIP on [getdata.finance](https://getdata.finance/datasets/usdcad) |
...
| --- | --- | --- | --- | --- | --- |
| 2024-09-02T00:00:00+00:00 | 1.34927 | 1.35655 | 1.3487 | 1.35092 | 561752.98518 |
| 2024-09-05T00:00:00+00:00 | 1.35092 | 1.35832 | 1.34656 | 1.35706 | 486573.98276 |
...
| datetime | open | high | low | close | volume |
| --- | --- | --- | --- | --- | --- |
| 2026-08-20T00:00:00+00:00 | 1.38054 | 1.38076 | 1.37248 | 1.3756 | 344719.46181 |
| 2026-08-23T00:00:00+00:00 | 1.38074 | 1.38669 | 1.37826 | 1.38378 | 372643 |
...
| 2026-09-01T00:00:00+00:00 | 1.38522 | 1.39066 | 1.38449 | 1.39036 | 204130 |
...
The complete **USDCAD** archive on **[getdata.finance](https://getdata.finance/datasets/usdcad)** includes **11 OHLCV timeframes** (1m · 3m · 5m · 15m · 30m · 1H · 4H · 12H · 1D · 3D · 1W) — **3,013** rows at `3d`, plus all other timeframes in the same ZIP.
